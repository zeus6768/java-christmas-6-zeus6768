...
public class OutputMessage {
    protected static final String NOT_EXISTS = "없음\n";

    protected static final String GUIDE_INTRO = "안녕하세요! 우테코 식당 " + MONTH +"월 이벤트 플래너입니다.\n";
    protected static final String GUIDE_BENEFIT_PREVIEW = MONTH + "월 %d일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!\n";

    protected static final String TITLE_ORDER = "\n<주문 메뉴>\n";
    ...
    protected static final String TITLE_EVENT_BADGE = "\n<" + MONTH + "월 이벤트 배지>\n";
    ...
    protected static final String EVENT_BADGE = "%s\n";
}
